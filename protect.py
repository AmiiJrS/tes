...
#vidia
kt = LINETCR.LINE()
kt.login(token="EnoMEC0TSogKmjuRUJye.6v6loJKDOdhcGmohufs+3G.3rdcmIAbYEFzEL6Ilo0pHwfqxFeN0MbaHgl+bBX3ous=")

#rosetta
ks = LINETCR.LINE()
ks.login(token="EnqyL1P9spmBYTFUdupe.bAIYpoEqTyYTIYPwAn74ZG.C2KLYQJj7Y73T874EgkqnWCL1D7p9KN88VScjFEWKS0=")

#sirvelmist
ki = LINETCR.LINE()
ki.login(token="EnFSLtK3tNuyfPK21h74.NY1SLGUcS9sBsyVPCsExja.m+zsY+R2l0pWZWS0jXYn1S4EhoVw1JAXfX5OJXnYxt0=")

#fawn
kk = LINETCR.LINE()
kk.login(token="Encd5MG31ChG64Gur8x7.pz/yHO8eziJsV+m4m9sR9W.tPnhjszYh5bXT68uD0aFK+WTk1tVSYTqckw3reR/3qQ=")

#iridessa
kc = LINETCR.LINE()
kc.login(token="EnO5uELkHUKGfUMCS5o7.KztPtoRqD+dZnu9BdOci5W./4ZXYHmMpGn/hDHounYadSnx+fhoXyM5SOvNmMxprdQ=")

#kicker ghost
#kl = LINETCR.LINE()
#kl.login(token="Enujzy4qwkW3DCD0CH59.BnT5+wuIUZDBwsJtpBtkYq.8aXZq1Hk1ZautWJqUAFKZ7GH0E5MLKNLcRJhc/lG6fc=")
...
admin = ["u36196ea7137f95585062f8303dbac814","u05a8b23ce790b58cad8b2a5668def8ce"]
owner = ["u36196ea7137f95585062f8303dbac814","u05a8b23ce790b58cad8b2a5668def8ce"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    "lang":"JP",
    "comment":"AutoLike by ✍D̴E̴D̴I̴ T̴E̴A̴M̴B̴O̴T̴✈",
...
#------------------------------------------------
              ...
              if msg.from_ in admin:
                ki.sendText(msg.to,"PONG 􀨁􀄻😎😎")
                kk.sendText(msg.to,"PONG 􀨁􀄻😎😎")
                kc.sendText(msg.to,"PONG 😎😎")
		ks.sendText(msg.to,"PONG 􀨁􀄻😎😎")
		kt.sendText(msg.to,"PONG 😎😎􀨁􀄻")
...
#========================================
              ...
              if wait["tag"] == True:
                ...
                resp = ("《《AUTO RESPON》》\n")
                jawab = ("apa kak ? ketik /help untuk bantuan","Cie Ada Yang Kangen\nketik /help.")
